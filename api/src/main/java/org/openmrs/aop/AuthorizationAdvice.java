 ...
 * being {@code @PreAuthorize}, wired via {@link org.openmrs.security.OpenmrsMethodSecurityConfig}.
 * This advice, and the {@link org.openmrs.annotation.Authorized} annotation it enforces, remain
 * fully supported; there is no need to convert existing usages to {@code @PreAuthorize}.
 */
